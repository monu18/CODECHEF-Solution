 ...
 //num len = s.size();
    ...
    if (flag==0) {
      ...
      for (size_t i = 0; i < s.length()/2; i++) {
        ...
        if (s[i]=='2'&&  s[s.length()-1-i]!='7') {
          /* code */
          p1("false")
          flag=1;
          break;
        }
        if (s[i]=='7'&&  s[s.length()-1-i]!='2') {
          /* code */
          p1("false")
          flag=1;
          break;
        }
        if (s[i]=='3'&&  s[s.length()-1-i]!='8') {
          /* code */
          p1("false")
          flag=1;
          break;
        }
        if (s[i]=='8'&&  s[s.length()-1-i]!='3') {
          /* code */
          p1("false")
          flag=1;
          break;
        }
        if (s[i]=='4'&&  s[s.length()-1-i]!='5') {
          /* code */
          p1("false")
          flag=1;
          break;
        }
        if (s[i]=='5'&&  s[s.length()-1-i]!='4') {
          /* code */
          p1("false")
          flag=1;
          break;
        }
        if (s[i]=='6'&&  s[s.length()-1-i]!='9') {
          /* code */
          p1("false")
          flag=1;
          break;
        }
        if (s[i]=='9'&&  s[s.length()-1-i]!='6') {
          /* code */
          p1("false")
          flag=1;
          break;
