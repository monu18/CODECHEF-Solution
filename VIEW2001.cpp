...
//  clock_t launch=clock();
 ...
 //num len = s.size();
  ...
  tc
  {
     ...
     if (s=="POUNDS") {
       /* code */
       cout<<"$"<<n<<" "<<"CONVERTS TO "<< ans1*0.84 <<" POUNDS"<<"\n";
     }
     if (s=="LIRA") {
       /* code */
       cout<<"$"<<n<<" "<<"CONVERTS TO "<< ans1*2040  <<" LIRA"<<"\n";
     }
     if (s=="FRANCS") {
       /* code */
       cout<<"$"<<n<<" "<<"CONVERTS TO "<< ans1*9.85 <<" FRANCS"<<"\n";
     }
     if (s=="MARKS") {
       /* code */
       cout<<"$"<<n<<" "<<"CONVERTS TO "<< ans1*3.23  <<" MARKS"<<"\n";
     }
     if (s=="YEN") {
       /* code */
       cout<<"$"<<n<<" "<<"CONVERTS TO "<< ans1*260  <<" YEN"<<"\n";
     }
